...
class CacheFeedUseCaseTests: XCTestCase {
    ...
    func test_save_failrsOnInsertionError() {
        let (sut, store) = makeSUT()
    ...
    private func uniqueItems() -> (models: [FeedItem], local: [LocalFeedItem]) {
        ...
        let localModels = models.map { LocalFeedItem(id: $0.id, description: $0.description, location: $0.location, imageURL: $0.imageURL) }
